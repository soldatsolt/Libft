...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/06 10:18:18 by kmills            #+#    #+#             */
...
void				make_t_width(va_list vl, t_flags *fl, \
					const char *restrict *format);
void				make_t_precision(va_list vl, t_flags *fl, \
					const char *restrict *format);
...
int					ft_long_double_exception(long double n, t_buf **buf,
					t_flags fl);
void				ft_free_dd(t_double *dd);
void				o_flag1(t_flags fl, t_buf **buf, char *s, char *str);
char				*make_str_with_precision_for_lu(t_flags fl,
					unsigned long k);
char				*make_str_with_precision_for_llu(t_flags fl,
					unsigned long long k);
char				*make_str_with_precision_for_hu(t_flags fl,
					unsigned short k);
char				*make_str_with_precision_for_hhu(t_flags fl,
					unsigned char k);
void				x_flag1(t_buf **buf, t_flags fl,
					char *(*f)(unsigned int, int), unsigned int k);
...
char				*make_str_with_precision_for_llx(t_flags fl,
					unsigned long long k, char *(*f)(unsigned long long, int));
char				*make_str_with_precision_for_lx(t_flags fl, unsigned long k,
					char *(*f)(unsigned long, int));
void				x_flag1_hh(t_buf **buf, t_flags fl,
					char *(*f)(unsigned char, int), unsigned char k);
void				x_flag1_h(t_buf **buf, t_flags fl,
					char *(*f)(unsigned short, int), unsigned short k);
void				x_flag1_ll(t_buf **buf, t_flags fl, char *(*f)
					(unsigned long long, int), unsigned long long k);
void				x_flag1_l(t_buf **buf, t_flags fl,
					char *(*f)(unsigned long, int), unsigned long k);
void				i_flag_hh(va_list vl, t_buf **buf, t_flags fl);
...
char				*make_str_with_precision_for_hho(t_flags fl,
					unsigned char k);
char				*make_str_with_precision_for_ho(t_flags fl,
					unsigned short k);
char				*make_str_with_precision_for_llo(t_flags fl,
					unsigned long long k);
char				*make_str_with_precision_for_lo(t_flags fl,
					unsigned long k);
